...
export const experiencesData = [
  ...
  },
  {
    ...
    description:
      "Conducted Research at WIMR alongside leading scientists. My research was focused on alternative treatment for bone infection. Graduated with First Class Honours.",
